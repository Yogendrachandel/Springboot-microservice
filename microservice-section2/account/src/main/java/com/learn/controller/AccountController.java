...
import com.learn.service.impl.AccountsServiceImpl;
...
public class AccountController {
    ...
    //   PathVariable  , when request comes in - http://localhost:8080/api/getInfo/4365656
 /*   public ResponseEntity<CustomerDto> getCustomerDetails(@PathVariable String mobileNumber){
        log.info(" Get endpoint call with mobile number :{}",mobileNumber);
    ...
    /* @RequestParam - when request comes in query format with ? and key value format as below format:
       http://localhost:8080/api/getInfo?mobileNumber=455745
    */
    @GetMapping("/getInfo")
