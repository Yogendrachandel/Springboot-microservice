In this section we have Oath2.0 ,so please read the PDF file section for oauth2 section
and how to configure the KeyCloack at local system steps by step.
